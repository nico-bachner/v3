...
This is the procedure I refer to when doing a clean (re)install on a Mac.

## System Settings

The first thing I do when the initial setup procedure is done is customise the trackpad settings (_System Preferences > View > Trackpad_).
...
Then I move on to the Dock settings (_System Preferences > View > Dock & Menu Bar_):
...
1. Adjust Preferences (_Terminal > Preferences_):
...
2. Show Status Bar: _Safari > View > Show Status Bar_

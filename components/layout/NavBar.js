...
export default function NavBar(props) {
    ...
    return (
        <nav className="top-0 z-50 flex items-center justify-between max-w-4xl px-8 py-4 mx-auto my-8 text-black bg-white dark:text-white sm:py-8 sm:sticky dark:bg-black bg-blur">
            ...
            <ul className="justify-end flex-grow hidden space-x-8 text-lg font-medium sm:flex ">
